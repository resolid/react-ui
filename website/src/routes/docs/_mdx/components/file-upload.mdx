  ...
  return (
    <FileUpload transport={uploadthingTransport}>
      <FilePicker
        ...
        className="w-full"
      >
        <FilePickerList orientation="horizontal">
        ...
        <FilePickerDropzone className="relative size-25">
          <FilePickerTrigger className="absolute inset-0 flex justify-center enabled:hover:cursor-pointer enabled:hover:bg-bg-subtlest">
  ...
  return (
    <FileUpload transport={uploadthingTransport}>
      ...
      >
        ...
        <FilePickerDropzone className="relative size-25">
          <FilePickerTrigger className="absolute inset-0 flex justify-center text-fg-subtlest enabled:hover:cursor-pointer enabled:hover:bg-bg-subtlest">
