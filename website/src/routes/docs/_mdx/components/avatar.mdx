  ...
  return (
    <div className="flex flex-row items-center justify-center gap-6">
      <Avatar name="Alex Suprun">
        ...
        <AvatarFallback />
        <AvatarIndicator>
          <span className="h-5 w-5 rounded-full border-4 border-bg-subtlest bg-bg-success-emphasis" />
        </AvatarIndicator>
      </Avatar>
      <Avatar name="Alex Suprun">
        <AvatarImage src="https://file.resolid.tech/images%2Fa007.png" />
      ...
      <Avatar name="Alex Suprun">
        ...
        <AvatarFallback />
        <AvatarIndicator position="bottom">
          <span className="h-5 w-5 rounded-full border-4 border-bg-subtlest bg-bg-danger-emphasis" />
        </AvatarIndicator>
      </Avatar>
